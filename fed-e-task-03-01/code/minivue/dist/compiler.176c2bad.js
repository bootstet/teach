...
var Compiler = /*#__PURE__*/function () {
  ...
  _createClass(Compiler, [{
    ...
    value: function compileText(node) {
      ...
      if (reg.test(value)) {
        var key = RegExp.$1.trim(); // 获取匹配正则里的值

        node.textContent = value.replace(reg, this.vm[key]); // c创建watcher对象，当数据改变 更新视图
...
},{}]},{},["../../../../../.npm/_npx/20422/lib/node_modules/parcel/src/builtins/hmr-runtime.js","js/compiler.js"], null)
